...
SELECT * FROM Products ORDER BY Price, ProductName DESC;
...
UPDATE Products SET Price = 15, Unit = "15 Boxes"  WHERE ProductID = 77;

/* AND, OR, NOT */
SELECT * FROM customers WHERE CustomerID >= 50 AND CustomerID <= 60;
SELECT * FROM shippers WHERE ShipperName = "Speedy Express" OR ShipperName = "Federal Shipping";
...
SELECT * FROM Products WHERE Price NOT BETWEEN 0 AND 20;
SELECT * FROM Employees WHERE BirthDate BETWEEN "1950-01-01" AND "1960-01-01";

/* Like */

/* Clientes que empiecen por A */
SELECT * FROM employees WHERE FirstName LIKE "A%";
/* Clientes que terminen en t */
SELECT * FROM employees WHERE FirstName LIKE "%t";
/* Clientes que contengan una a y una n seguidas */
SELECT * FROM employees WHERE FirstName LIKE "%an%";
SELECT * FROM employees WHERE LastName LIKE "Da_____";
...
CREATE PROCEDURE NumberSquare (IN number INT) 
BEGIN
    SELECT POW(number, 3);
END;
